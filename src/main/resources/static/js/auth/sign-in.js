function emailValidate() {
    ...
    if (email === "") {
        errorEmail.innerHTML = signInErrorMessages.emailRequired;
        isValid = false;
    } else if (patternEmail.test(email) === false) {
        errorEmail.innerHTML = signInErrorMessages.emailInvalid;
        isValid = false;
    } else {
    ...
    if (password === "") {
        errorPassword.innerHTML = signInErrorMessages.passwordRequired;
        isValid = false;
    } else if (patternPassword.test(password) === false) {
        errorPassword.innerHTML = signInErrorMessages.passwordInvalid;
        isValid = false;
    } else {
...
function otpValidate() {
    ...
    console.log(otp);
    if (otp === "") {
        errorOtp.innerHTML = signInErrorMessages.otpRequired;
        isValid = false;
    } else if (patternOtp.test(otp) === false) {
        errorOtp.innerHTML = signInErrorMessages.otpInvalid;
        isValid = false;
    } else {
        errorOtp.innerHTML = "";
    }
